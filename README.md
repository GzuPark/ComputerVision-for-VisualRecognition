...
|:----:|:----:|:----:|:----:|:----:|:----:|
|  1 | 컴퓨터비전기반 물체 인식 |  [이론](https://www.dropbox.com/s/nixwm5t9s11vwej/CVOR.pdf?dl=0)    | [실습1](1주차-실습1.md), [실습2](1주차-실습2.md), [실습3](1주차-실습3.md) | [개발환경](1주차-개발환경구축.pdf) | RCV@Sejong 연구원  |
|  2 | 기계학습기반 물체 인식 |   ...    |  ...     |   |   |
|  3 | 딥러닝기반 물체 인식-2D |  ...     |  ...     |   |   |
|  4 | 딥러닝기반 물체 인식-3D |   ...    |  ...     |   |   |
